  ...
  return (
    <Container>
        ...
        <Row>
            <Col sm={4}>
                <Row>
                    <img className='primary-image' src={product.img} alt="" />
                </Row>
                <Row>
                    <div className="gallery-block">
                    <img onClick={(e) => changePrimaryImage(e, product.img)} className='secondary-image' src={product.img} alt="" />
                        {product.images && product.images.map((image) => (
                            <img className='secondary-image' key={image} onClick={(e) => changePrimaryImage(e, image)} src={image} alt="" />
                        ))}
                    </div>
                </Row>
            </Col>
